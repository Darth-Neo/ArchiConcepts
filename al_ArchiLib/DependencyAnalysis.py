...
from al_ArchiLib.ImportNeo4J import ImportNeo4J
...
def dependancyAnalysis():
    ...
    if True:
        cg = ConceptsGraph(fileImage="DependancyAnalysis.png")
    ...
    for x in listTSort:
        ...
        ArchiLib.addToNodeDict(al.dictNodes[x[0]]["name"], al.dictBP)
        ArchiLib.addToNodeDict(al.dictNodes[x[1]]["name"], al.dictBP)
