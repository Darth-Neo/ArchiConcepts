...
class ConceptsGraph(object):
    ...
    def conceptsGraph(self, concepts):
        ...
        logger.info("Adding %s nodes the graph ..." % type(self, self.graph))
        self.addGraphNodes(self.graph, concepts)

        logger.info("Adding %s edges the graph ..." % type(self, self.graph))
        self.addGraphEdges(self.graph, concepts)
